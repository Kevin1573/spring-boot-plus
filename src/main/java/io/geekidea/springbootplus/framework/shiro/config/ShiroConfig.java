...
import io.geekidea.springbootplus.framework.shiro.filter.RequestPathFilter;
...
public class ShiroConfig {
     ...
     * 请求路径过滤器名称
     */
    private static final String REQUEST_PATH_FILTER_NAME = "path";//自定义shiro：filter
    /**
     * Shiro过滤器名称
     */
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager,
        ...
        Map<String, Filter> filterMap = getFilterMap(loginService, loginRedisService, jwtProperties, pathProperties);
    ...
    @Bean
    public RequestPathProperties pathProperties(){
        return new RequestPathProperties();
    }
    /**
     * 获取filter map
     *
    ...
    private Map<String, Filter> getFilterMap(LoginService loginService,
        ...
        filterMap.put(REQUEST_PATH_FILTER_NAME, new RequestPathFilter(pathProperties.getRequestPath()));
